			...
			'columnDefs': [
                {
                    ...
                    render: function (data, type, full, meta) {
                        var result = '<div class="btn-group" role="group">';
                            ...
                            result = result + '<button type="button" onclick="doDelete(\'' + meta.row + '\');" class="btn btn-light-danger btn-icon btn-sm me-2" data-toggle="kt-tooltip" data-placement="top" title="Hapus"><i class="ki-outline ki-trash fs-4"></i></button>';

                            result = result + '<a href="detailEditCost.html" class="btn btn-light-warning btn-icon btn-sm" title="Hapus"><i class="ki-outline ki-notepad-bookmark fs-4"></i></a>';
